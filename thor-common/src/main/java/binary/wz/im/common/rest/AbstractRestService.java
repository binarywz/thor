package binary.wz.im.common.rest;
...
public abstract class AbstractRestService<T> {
    ...
    public AbstractRestService(Class<T> clazz, String url) {
    ...
    protected <T> T doRequest(RestFuture<T> function) {
        try {
    ...
    protected interface RestFuture<T> {
        /**
         * 执行一个http请求
         * @return
         * @throws IOException
